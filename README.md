...
[![Go Report Card](https://goreportcard.com/badge/github.com/brucewangzhihua/gin-swagger)](https://goreportcard.com/report/github.com/brucewangzhihua/gin-swagger)
[![GoDoc](https://godoc.org/github.com/brucewangzhihua/gin-swagger?status.svg)](https://godoc.org/github.com/brucewangzhihua/gin-swagger)
...
$ swag init
```
4. Download [gin-swagger](https://github.com/brucewangzhihua/gin-swagger) by using:
```sh
$ go get -u github.com/brucewangzhihua/gin-swagger
$ go get -u github.com/brucewangzhihua/gin-swagger/swaggerFiles
```
And import following in your code:

```go
import "github.com/brucewangzhihua/gin-swagger" // gin-swagger middleware
import "github.com/brucewangzhihua/gin-swagger/swaggerFiles" // swagger embed files
